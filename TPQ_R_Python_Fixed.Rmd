...
corrplot(cor(t(data_reco_all[[1]][,9:108])))
...
# I assume that reconstruction can be calculated as follows:
# original_df x single source (a matrix)
SS = as.vector(as.matrix(sources_mdd[1,]))
SS = matrix(c(SS,rep(0,9900)), ncol = 100, byrow = TRUE)

XX = as.matrix(data_tpq_mdd[,9:108])
XX%*%SS
