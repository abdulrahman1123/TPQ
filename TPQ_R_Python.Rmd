...
sapply(1: length(df_fast_list), function(x)
  ggsave(paste0("/home/asawalma/git/TPQ/figures/Q_Threshold_FastICA_Boot_",x,".png"),
...
sapply(1: length(df_noboot_fast_list), function(x)
  ggsave(paste0("/home/asawalma/git/TPQ/figures/Q_Threshold_FastICA_NoBoot_",x,".png"),
...
sapply(1: length(df_info_list), function(x)
  ggsave(paste0("/home/asawalma/git/TPQ/figures/Q_Threshold_Infomax_Boot_",x,".png"),
